...
const Index = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Seamlessly integrate cutting-edge laboratory information systems and automation solutions to modernize your operations.",
    },
    {
      icon: Microscope,
      title: "Provision of Casual Pathologists' Assistants",
      description:
        "Data-driven analysis and strategic recommendations to optimize every aspect of your laboratory's performance.",
    },
    {
      icon: ShieldCheck,
      title: "Expertise in Standardization of Practice",
      description:
        "Comprehensive safety program development and regulatory compliance guidance to protect your staff and patients while meeting all industry standards.",
    },
    {
      icon: Settings,
      title: "Strategies to Enhance Staff Engagement",
      description:
        "Strategic equipment planning, maintenance programs, and utilization analysis to maximize ROI and ensure reliable laboratory operations.",
    },
  ];
  const faqs = [
    {
